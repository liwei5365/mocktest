...
public class EmployeeDaoConstructorImpl implements EmployeeDao {

	public enum Dialect {
		MYSQL, ORACLE
	}

	public EmployeeDaoConstructorImpl() {
		super();
	}

	public EmployeeDaoConstructorImpl(boolean lazy, Dialect dialect) {
		super();
